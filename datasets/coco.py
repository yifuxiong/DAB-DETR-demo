...
def build(image_set, args):
    ...
    # }
    PATHS = {
        "train": (root / 'val2017', root / f'annotations_{mode}_train2017.json'),
        "val": (root / 'val2017', root / f'annotations_{mode}_val2017.json'),
    }
...
if __name__ == "__main__":
    ...
    parser.add_argument('--coco_path', type=str, default='D:/coco')
    parser.add_argument('--fix_size', default=False)
